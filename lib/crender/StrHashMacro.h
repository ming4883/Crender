...
static const size_t CR_HASH_CONSTANTS[CR_HASH_DEPTH+1] =
{
...
static const size_t CR_HASH_MULTS[CR_HASH_DEPTH+1] =
{
...
#define CrHash(string) CR_HASH_RECURSE_00(string, *string)
