...
public abstract class NvGLESActivity extends NvActivity
{
    ...
    protected boolean systemInit()
    {
        ...
        initRunnable = new Runnable()
        {
            public void run()
            {
                ...
                if (!init())
                {
                	final String msg = getLastErrorMsg();
        ...
        holder.addCallback(new Callback()
        {
            ...
            public void surfaceCreated(SurfaceHolder holder)
            {
                ...
                if (eglContext == null)
                {
    				...
    				{
    					System.out.println("Setting fixed window size of " + fixedWidth + " x " + fixedHeight );
     ...
     */
    public abstract boolean render(float time, int drawWidth, int drawHeight, boolean forceRedraw);
